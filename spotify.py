...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='83b6c48820634873be33d64e092ace6f3',  # Replace with your Client ID
    client_secret='32de2b3defbe4ce7addf19d33d558a49'  # Replace with your Client Secret
))

# Full track URL (example: Shape of You by Ed Sheeran)
track_url = "https://open.spotify.com/track/63q3GlHZstxXzfb0zt7ZYY"
